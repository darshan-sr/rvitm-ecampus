...
st.markdown("<div style='text-align:center;'><h1>About RVITM E-Campus</h1></div>", unsafe_allow_html=True,)
st.title("")
aboutmessage = "Welcome to RVITM E-Campus, the academic web application of RV Institute of Technology & Management. Our platform is designed to streamline the academic processes for students, teachers, and administrators with the use of cutting-edge technologies like Python, Firebase, Django, Plotly, and ReportLab. Our goal is to provide an easy-to-use, efficient, and accurate solution for result analysis, progress report generation, and student attendance management."
...
aboutmessage3 = "RVITM E-Campus is built with the user in mind and is designed to simplify the complexities of the academic process, making it easy to access and understand for everyone involved. With its user-friendly interface and powerful analytical tools, you can quickly analyze student performance, generate progress reports, and monitor attendance with ease."
...
aboutmessage5 = "Thank you for choosing RVITM E-Campus. We hope you find it useful and we look forward to serving you."
